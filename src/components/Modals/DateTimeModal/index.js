    ...
    <Modal
      ...
      <View style={styles.modalContainer}>
        <View style={{marginBottom: '10%'}}>
          {props.reminder ? (
            <Text style={styles.headingText}>Reminder Time</Text>
          ) : props.start ? (
            <Text style={styles.headingText}>Starting Date Time</Text>
          ) : (
            <Text style={styles.headingText}>Expiry Date Time</Text>
          )}
        </View>
        <View
          style={{
