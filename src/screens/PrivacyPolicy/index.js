...
class TermsAndCondition extends Component {
    ...
    render() {
        ...
        <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Medicos Connect</p>
        ...
        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Medicos Connect LLC, Wichita, Kansas.</p>
        ...
        <p><strong>Facebook Fan Page</strong> is a public profile named Medicos Connect specifically created by the Company on the Facebook social network, accessible from <a href="https://www.facebook.com/Medicos-Connect-101879488683154/?ref=pages_you_manage">https://www.facebook.com/Medicos-Connect-101879488683154/?ref=pages_you_manage</a></p>
        ...
        <p><strong>Website</strong> refers to Medicos Connect, accessible from www.medicosconnect.com</p>
        ...
        <p>Unity Ads collects, stores, uses, processes, and transfers personal information to provide, operate, and improve Unity Technologies services, including personalized advertising services. For more information on what type of information Unity Technologies collects, please visit their Privacy Policy page: <a href="https://unity3d.com/legal/privacy-policy">https://unity3d.com/legal/privacy-policy</a>.</p>
        <p>You can prevent Unity Ads from using your information by opting-out. To opt-out of Unity Analytics, please visit this page: <a href="https://unity3d.com/legal/privacy-policy">https://unity3d.com/legal/privacy-policy</a></p>
        ...
        <p>The Company is the Data Controller of Your Personal Data collected while using the Service. As operator of the Facebook Fan Page <a href="https://www.facebook.com/Medicos-Connect-101879488683154/?ref=pages_you_manage">https://www.facebook.com/Medicos-Connect-101879488683154/?ref=pages_you_manage</a>, the Company and the operator of the social network Facebook are Joint Controllers.</p>
        ...
        <p>By email: info@medicosconnect.com</p>
        <p>By visiting this page on our website: www.medicosconnect.com</p>
        ...
        <p>Our Service does not address anyone under the age of 13. We do not knowingly collect personally identifiable information from anyone under the age of 13. If You are a parent or guardian and You are aware that Your child has provided Us with Personal Data, please contact Us. If We become aware that We have collected Personal Data from anyone under the age of 13 without identification of parental consent, We take steps to remove that information from Our servers.</p>
        ...
        <p>By email: info@medicosconnect.com</p>
        <p>By visiting this page on our website: www.medicosconnect.com</p>`
        return <View style={{ flex: 1, backgroundColor: "white", paddingBottom: this.props?.route?.params?.setting ? "30%": "0%",paddingHorizontal:"2%" }}>
