      ...
      <View
        ...
        <>
          ...
          <TouchableOpacity
              ...
              onPress={() =>onPressButton('2sec')}
            >
              <Text style={styles.textStyleMenu}>{'2 seconds'}</Text>
            </TouchableOpacity>
            {/* <TouchableOpacity
              style={{
                padding: 10,
            ...
            <TouchableOpacity
              ...
              onPress={() =>onPressButton('5sec')}
            >
              <Text style={styles.textStyleMenu}>{'5 seconds'}</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={{
                padding: 10,
              ...
              onPress={()=> onPressButton('10sec')}
            >
              <Text style={styles.textStyleMenu}>{'10 seconds'}</Text>
            </TouchableOpacity>
          </View>
        </>
      </View>
