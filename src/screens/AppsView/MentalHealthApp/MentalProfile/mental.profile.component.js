...
import ColorLike from '../../../../assets/svg/colorlike-icon.svg';
        ...
        <>
          ...
          <View style={{}}>
            ...
            <TouchableOpacity
              ...
              <Text style={styles.textStyleMenu}>{'Move To Trash'}</Text>
              {<Delete fill={themeStyle.COLOR_BLACK} />}
            </TouchableOpacity>
          </View>
        </>
      </View>
