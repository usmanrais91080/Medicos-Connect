...
export const HeaderRight = ({ showFilterText,onPressSticker,onPressText,onPressArrow,TextFoucs,OnPressAlignText,OnPressShowTextColors,OnPressShowTextBgColors,OnPressDone }) => {
    return (
             <View>
                ...
                {/* <Text>{showFilterText}</Text> */}
                <TouchableOpacity
                  onPress={() =>onPressSticker()}>
                <Icon.MaterialCommunityIcons name="sticker-plus-outline" size={25} color={themeStyle.PRIMARY_TINT_COLOR} />
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() => onPressText()}>
                <Icon.MaterialCommunityIcons name="format-text" size={25} color={themeStyle.PRIMARY_TINT_COLOR} />
                </TouchableOpacity>
