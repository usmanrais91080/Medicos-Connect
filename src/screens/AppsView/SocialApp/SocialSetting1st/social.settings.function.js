...
/**
 * Get user Social Settings Data
 * @param userDataToken
 */

SocialSettingsFunction.prototype.getUserSocialProfileSettings = function (userDataToken) {
    return new Promise((resolve, reject) => {
        ProfileServices.getSocialProfileSettings(userDataToken)
